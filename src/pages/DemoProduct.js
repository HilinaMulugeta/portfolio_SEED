                ...
                <div className="container mx-auto my-8 px-4 lg:px-20" data-aos="zoom-in">
                    <form onSubmit={sendEmail} id="demoProductForm">
                        ...
                        <div className="my-2 w-1/2 lg:w-2/4">
                            <button type="submit" id="submitBtn" className="uppercase text-sm font-bold tracking-wide bg-[#5c999e] hover:bg-[#80d5dd] text-gray-100 p-3 rounded-lg w-full 
                    ...
                    <div className="w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-[#5c999e] rounded-2xl">
                        <div className="flex flex-col text-white">     
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">Tel: +251974777772</p>
                                
                                    <div className='mt-5'>
                                        <h2 className="text-2xl">Send an E-mail</h2>
                                        <p className="text-gray-400">gtforever2009@gmail.com</p>
                                    </div>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                <a href="" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-[#5c999e]  w-8 mx-1 text-center pt-1">
