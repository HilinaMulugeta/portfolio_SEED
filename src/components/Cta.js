            ...
            <div className="mx-8 w-full h-96 text-center lg:text-left py-16 px-12 flex lg:justify-between items-center">                    
                <div className="w-full flex flex-col lg:flex-row lg:justify-around">
                    <div className="mb-4">
                        ...
                        <p className="text-lg md:text-2xl">I’m always interested in new projects, collaborations, and challenges in software engineering and project management. Feel free to reach out</p>
                    </div>
                    
                    <div className="w-full lg:w-72 pt-6 lg:mx-12">
                        <Link to="/contact" className="bg-transparent border hover:bg-[#7cb9be] hover:border-[#a0edf4] text-white justify-center text-center rounded-lg px-10 py-3 flex items-center group">Send me a message
