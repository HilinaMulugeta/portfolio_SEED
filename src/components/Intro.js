                ...
                <div className="m-auto overflow-hidden mx-4 mt-8 lg:mt-14  p-2 md:p-12 h-full" data-aos="zoom-in">
                    ...
                    <div id='about' className="flex flex-col lg:flex-row lg:mx-4 lg:my-28 py-18 justify-center text-center lg:text-left">
                        ...
                        <div className="space-x-0 md:space-x-2 lg:w-60% flex flex-col mr-4 lg:mr-8 lg:justify-center " data-aos="zoom-in" data-aos-delay="200">
                            ...
                            <h1 className="mb-5 md:text-3xl text-2xl font-bold text-[#5c999e]">Educational Background</h1>
                            
                            <div className="text-lg  font-semibold pl-0 mb-5 text-gray-500">
                            With a Bachelor’s in Computer Science and a Master’s in Computer Engineering my career is built on creating reliable software solutions and leading complex projects. Starting as a developer and growing into a project leader, I’ve led teams, designed systems, and implemented solutions that improve organizational efficiency and user experiences.                
                                </div>
