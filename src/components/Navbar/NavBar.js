...
//                     <HashLink smooth to="/#hero"><h1 className="font-bold text-2xl font-mono text-[#649ba1]">Hilina Mulugeta</h1></HashLink>
                    
//                 </div>
//                 <div className="group flex flex-col items-center lg:justify-center w-full lg:w-full">
//                     <button className="p-2 rounded-lg lg:hidden text-[#7cb9be]" onClick={handleClick}>
