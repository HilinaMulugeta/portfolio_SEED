                    ...
                    <div className="col-span-12 text-center mx-auto lg:col-span-3 font-bold uppercase lg:text-[#4a7d81] md:text-gray-100">
                        ...
                        <div className="mx-auto text-center mt-2">
                                <ul className="flex justify-center mb-4 md:mb-0">
                                    <li>
                                        <Link to="#" className="flex justify-center items-center text-[#4a7d81] hover:text-gray-500 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Twitter">
                                    ...
                                    <li className="ml-4">
                                        <Link to="#" className="flex justify-center items-center text-[#4a7d81] hover:text-gray-500 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Facebook">
                                        <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
