            ...
            <div className="my-4 py-4 lg:my-28" id='portfolio'>
                ...
                <div className="px-5 lg:mx-8 lg:my-5" data-aos="fade-down" data-aos-delay="600">
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-12">                            
                        <div className="bg-[#f5e3ea] transition-all ease-in-out duration-400  overflow-hidden text-gray-600 hover:scale-105 rounded-lg shadow-2xl p-3 min-h-max">
                        ...
                        <div className="bg-[#f5e3ea] transition-all ease-in-out duration-400 overflow-hidden text-gray-600 hover:scale-105 rounded-lg shadow-2xl p-3">
                            <div className="m-2 text-justify text-sm">
                                <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-14 h-12 text-[#eda2bf]">
                                <a href="https://hilinamulugeta.github.io/HM/" target="_blank" rel="noopener noreferrer">👉My second portfolio (touch here)</a></h4>
                        ...
                        <div className="bg-[#f5e3ea] transition-all ease-in-out duration-400  overflow-hidden text-gray-600  rounded-lg  p-3">
                            <div className="m-2 text-justify text-sm">
                            <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-14 h-12 text-[#eda2bf]">A portfolio that I had done to my client.</h4>
